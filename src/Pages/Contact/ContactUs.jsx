...
const Contact = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center overflow-hidden w-full min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      {/* Background Pattern */}
      <div className={`absolute inset-0 transition-opacity duration-1000 ${isLoaded ? 'opacity-10' : 'opacity-0'}`}>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className={`text-black dark:text-white text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent transform transition-all duration-700 delay-200 ${
            isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
          }`}>
            Get In Touch
          </h1>
          
          <p className={`text-base text-gray-700 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed transform transition-all duration-700 delay-400 ${
            isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
          }`}>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          {/* Contact Form */}
          <div className={`flex-1 transform transition-all duration-700 delay-300 ${
            ...
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-md border border-gray-200 dark:border-gray-700 rounded-3xl shadow-2xl p-8 md:p-12 hover:-translate-y-2 transition-all duration-300">
              {/* Form Header */}
              <div className={`text-center mb-10 transform transition-all duration-500 delay-500 ${
              ...
              <div className="space-y-8">
                {/* Name & Email Fields */}
                <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 transform transition-all duration-500 delay-700 ${
                  isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
                }`}>
                  {/* Name */}
                ...
                {/* Message Field */}
                <div className={`space-y-2 transform transition-all duration-500 delay-800 ${
                  isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
                }`}>
                  <label
                    htmlFor="message"
                ...
                {/* Submit Button */}
                <div className={`text-center pt-4 transform transition-all duration-500 delay-900 ${
                  isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
                }`}>
                  <button
                    type="button"
