...
import { Sparkles, Zap, Code, Palette, Monitor, Layers, ArrowRight } from "lucide-react";
      ...
      <div className="text-center space-y-3">
        <div className="flex items-center space-x-2">
          ...
          <div className="flex space-x-1">
            ...
            <div className="w-1 h-1 bg-blue-500 dark:bg-purple-400 rounded-full animate-bounce" style={{ animationDelay: '0.1s' }}></div>
            <div className="w-1 h-1 bg-blue-500 dark:bg-purple-400 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center py-16">
          <div className="text-center max-w-lg mx-auto">
            ...
            <div className="relative mb-8">
              ...
              <div className="absolute -bottom-1 -left-2 w-3 h-3 bg-red-300 rounded-full animate-ping opacity-50" style={{ animationDelay: '0.5s' }}></div>
            </div>
...
function Window({ activeTab, activeFilter, searchQuery }) {
  ...
  return (
    <div className={`flex-1 min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-blue-950/30 overflow-y-auto transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
      {/* Background Pattern */}
        ...
        <div className="text-center mb-12 space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            {[
              ...
              <div key={index} className="flex items-center gap-2 px-3 py-1.5 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-lg shadow-sm border border-gray-200/50 dark:border-gray-700/50">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-br from-purple-400/10 to-pink-400/10 rounded-full blur-lg animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-32 left-20 w-28 h-28 bg-gradient-to-br from-pink-400/10 to-blue-400/10 rounded-full blur-xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
    </div>
  );
}
