      ...
      <div className="relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-semibold text-primary-600 dark:text-accent-400">
        ...
        >
          {plans.map((plan, idx) => (
            <motion.div
              ...
              whileHover={{
                y: plan.isPopular ? -3 : -2, // very small lift
                scale: plan.isPopular ? 1.005 : 1.008, // almost flat, just a tiny scale
            ...
            >
              ...
              {plan.isPopular && (
                <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 z-[60]">
                  <div className="bg-gradient-to-r from-primary-500 to-accent-500 dark:from-primary-600 dark:to-accent-600 text-white px-4 py-1.5 rounded-full text-sm font-bold shadow-xl border border-white dark:border-secondary-800 whitespace-nowrap">
                    ⭐ MOST POPULAR
                  </div>
                </div>
              )}
              ...
              <div className="w-full flex-1 relative z-10">
                ...
                <div
                  className={`w-16 h-16 mx-auto mb-6 rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform duration-300 ${
                    plan.isPopular
                ...
                <h2
                  className={`font-black text-xl sm:text-2xl md:text-3xl text-center mb-2 ${
                    plan.isPopular
                ...
                <div className="flex flex-col items-center my-6 sm:my-8">
                  <div className="flex items-baseline gap-2">
                    <span
                      className={`font-black text-3xl sm:text-4xl md:text-5xl ${
                        plan.isPopular
                          ? "bg-gradient-to-r from-primary-600 to-accent-600 dark:from-primary-400 dark:to-accent-400 bg-clip-text text-transparent"
                          : "text-secondary-900 dark:text-white"
                      }`}
