    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-20 space-y-32">
        ...
        <section className="flex flex-col md:flex-row items-center gap-12">
          <motion.div className="flex-1 space-y-6" variants={fadeInLeft} initial="initial" animate="animate">
            ...
            <p className="text-lg md:text-xl opacity-80 leading-relaxed">
              A powerful open-source animation UI library that simplifies creating beautiful, reusable animations for
        ...
        {/* Mission */}
        <section className="flex flex-col md:flex-row w-full md:min-h-[300px] rounded-2xl shadow-xl overflow-hidden">
          <motion.div
            className="w-full md:flex-1 min-h-40 md:min-h-0 bg-gradient-to-br from-purple-700 to-pink-600 dark:from-purple-900 dark:to-pink-800 text-white flex items-center justify-center p-8"
            whileHover={{ scale: 1.05 }}
            transition={{ type: "spring", stiffness: 200 }}
          >
            <h2 className="text-3xl font-extrabold tracking-wide text-center">Mission</h2>
          </motion.div>

          <motion.div
            className="w-full md:flex-[3] bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-200 flex items-center p-8"
        ...
        <section className="flex flex-col md:flex-row w-full md:min-h-[300px] rounded-2xl shadow-xl overflow-hidden">
          <motion.div
            className="order-1 md:order-2 w-full md:flex-1 min-h-40 md:min-h-0 bg-gradient-to-br from-purple-700 to-pink-600 dark:from-purple-900 dark:to-pink-800 text-white flex items-center justify-center p-8"
            whileHover={{ scale: 1.05 }}
            transition={{ type: "spring", stiffness: 200 }}
          >
            <h2 className="text-3xl font-extrabold tracking-wide text-center">Vision</h2>
          </motion.div>

          <motion.div
            className="order-2 md:order-1 w-full md:flex-[3] bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-200 flex items-center p-8"
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6, ease: "easeOut" }}
          >
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="opacity-80 text-sm">Instant integration, no complex setup</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {techUsed.map((tech) => (
              ...
              >
                ...
                <h3 className="mt-3 text-lg font-semibold text-blue-600 dark:text-blue-400">{tech.name}</h3>
        ...
        <section className="flex flex-col gap-8">
          ...
          <motion.div className="p-8 rounded-3xl text-center bg-gradient-to-tr from-indigo-50 to-white dark:from-secondary-800 dark:to-secondary-700 shadow-xl border border-indigo-200 dark:border-secondary-700 w-full">
            <h2 className="text-2xl font-bold mb-4 text-indigo-700 dark:text-indigo-400">Ready to Start?</h2>
            <p className="text-sm opacity-80 mb-4">Explore our components and start building today.</p>
        ...
        <section className="w-full py-20 bg-gradient-to-r from-blue-300 to-pink-300 dark:from-gray-800 dark:to-purple-900 text-black dark:text-white rounded-3xl text-center px-6 transition-colors duration-500">
          {/* Tagline */}
          <h2 className="text-3xl md:text-3xl font-extrabold mb-4">Ready to Begin Your AnimateHub Adventure?</h2>

          {/* Subheading / Description */}
          <p className="text-base text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Explore creative animation components, enhance your projects, and join a vibrant developer community. Your
            journey starts here!
          </p>
        ...
        <section className="text-center p-8 rounded-3xl bg-gradient-to-tr from-purple-200 to-white dark:from-secondary-800 dark:to-secondary-700 shadow-xl border border-purple-500 dark:border-secondary-700">
          <h2 className="text-2xl font-bold mb-2 text-black dark:text-white">Connect With Us</h2>
          <p className="text-sm opacity-80 mb-4">Follow us for updates, tips, and community highlights.</p>
