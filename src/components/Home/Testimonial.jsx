...
const TestimonialCard = ({ text, name, image }) => {
  return (
    <div className="p-4 sm:p-6 md:p-8 h-auto min-h-[200px] sm:min-h-[240px] rounded-lg shadow-lg bg-primary-50 dark:bg-secondary-800 text-secondary-900 dark:text-white flex flex-col justify-between relative transition-transform transform hover:scale-105">
      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-0 mt-auto">
        ...
        <div className="text-center sm:text-left">
          <h5 className="font-bold text-xs sm:text-sm md:text-base">{name}</h5>
        </div>
      </div>
    </div>
  );
