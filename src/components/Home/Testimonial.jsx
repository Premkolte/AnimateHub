...
const TestimonialCard = ({ text, name, image }) => {
  return (
    <div className="p-8 h-60 rounded-lg shadow-lg bg-primary-50 dark:bg-secondary-800 text-secondary-900 dark:text-white flex flex-col justify-between relative transition-transform transform hover:scale-105">
