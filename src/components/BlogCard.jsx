  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden">
        <motion.div variants={imageVariants} className="h-48 w-full">
          <img
            src={blog.cover}
            alt={blog.title}
      ...
      <div className="relative z-10 p-6 flex flex-col flex-1 space-y-4">
        ...
        >
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-gradient-to-r from-green-400 to-green-500 rounded-full border-2 border-white dark:border-slate-800" />
          </div>
        ...
        >
          ...
          >
            ...
            <span className="relative z-10 flex items-center gap-2">
              <motion.span
                animate={
                  likedByMe.has(blog.id) ? { scale: [1, 1.3, 1] } : {}
                }
          ...
          >
            <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 bg-gradient-to-r from-transparent via-white/20 to-transparent" />
            <span className="relative z-10 flex items-center gap-2">
              <motion.span whileHover={{ rotate: 15 }} className="text-base">
                🔗
              </motion.span>
        ...
        >
          <motion.button
            onClick={() => onOpenModal({ ...blog, tags: safeTags })}
      ...
      <div className="absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-blue-500/50 dark:group-hover:border-blue-400/50 transition-all duration-300 pointer-events-none" />
    </motion.article>
  );
}