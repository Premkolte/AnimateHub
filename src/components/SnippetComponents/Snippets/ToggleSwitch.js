export const toggleSwitchSnippets = [
    {
      ...
      jsxCode:
        `<div className="relative inline-block w-20 h-10">
            ...
            <label for="toggle" className="inline-block switch-container cursor-pointer w-full h-full rounded-full animate-bounce transition-colors duration-300 bg-red-400 peer-checked/button1:bg-green-400 peer-checked/button1:[&>span]:translate-x-full peer-checked/button1:[&>span]:bg-gray-500">
