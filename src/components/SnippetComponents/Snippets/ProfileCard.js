...
export const profileCardSnippets = [
    {
      ...
      jsxCode: `(props) => (
        <div className="bg-white rounded-lg overflow-hidden shadow-lg">
          <img src="profile.jpg" alt="Profile" className="w-full h-32 object-cover" />
          <div className="p-4">
      ...
      cssCode: `<div style="background-color: #fff; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        <img src="profile.jpg" alt="Profile" style="width: 100%; height: 200px; object-fit: cover;" />
    ...
    },
    {
      ...
      jsxCode: `(props) => (
        <div className="bg-white rounded-lg overflow-hidden shadow-lg">
          <img src="profile.jpg" alt="Profile" className="w-full h-40 object-cover" />
          <div className="p-4">
