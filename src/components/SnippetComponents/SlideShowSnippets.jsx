// SlideshowSnippets.js

import React, { useState } from 'react';
import Modal from '../Modal';
import StringToReactComponent from 'string-to-react-component';
import { slideshowSnippets } from './Snippets/Slideshows'; // Assuming you have slideshow snippets defined

const SlideshowSnippets = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {slideshowSnippets.map((snippet, index) => (
...
export default SlideshowSnippets;
