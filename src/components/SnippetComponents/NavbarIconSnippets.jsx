// NavbarIconSnippets.js

import React, { useState } from 'react';
import Modal from '../Modal';
import StringToReactComponent from 'string-to-react-component';
import { navbarIconSnippets } from './Snippets/NavbarIcon'; // Assuming you have navbar icon snippets defined
...
const NavbarIconSnippets = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {navbarIconSnippets.map((snippet, index) => (
...
export default NavbarIconSnippets;
