// ProfileCardSnippets.js

import React, { useState } from 'react';
import Modal from '../Modal';
import StringToReactComponent from 'string-to-react-component';
import { profileCardSnippets } from './Snippets/ProfileCard'; // Define your profile card snippets

const ProfileCardSnippets = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {profileCardSnippets.map((snippet, index) => (
...
export default ProfileCardSnippets;
