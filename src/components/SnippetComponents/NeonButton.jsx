...
const NeonButton = () => {
  ...
  return (
    <div className="flex justify-center items-center  bg-gradient-to-br from-white via-gray-50/30 to-blue-50/30 dark:from-gray-900 dark:via-gray-800/80 dark:to-gray-900/50 rounded-lg">
