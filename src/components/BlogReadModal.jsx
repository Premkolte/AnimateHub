    ...
    return paragraphs.map((paragraph, index) => {
      ...
      if (paragraph.startsWith('#')) {
        ...
        return (
          ...
          >
            {level === 1 && (
              <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100 mb-4 pb-2 border-b-2 border-gradient-to-r from-blue-500 to-purple-500">
                {text}
              </h1>
            )}
            {level === 2 && (
      ...
      const formatText = (text) => {
        // Handle inline code
        text = text.replace(/`([^`]+)`/g, '<code class="bg-slate-200 dark:bg-slate-700 text-blue-600 dark:text-blue-400 px-2 py-1 rounded text-sm font-mono">$1</code>');
        
        // Handle bold
        text = text.replace(/\*\*([^*]+)\*\*/g, '<strong class="font-bold text-slate-800 dark:text-slate-100">$1</strong>');
        
        // Handle italic
        text = text.replace(/\*([^*]+)\*/g, '<em class="italic text-slate-600 dark:text-slate-300">$1</em>');
      ...
      return (
        <motion.p
          ...
          className={`text-base sm:text-lg leading-relaxed text-slate-700 dark:text-slate-200 mb-4 ${
            index === 0 ? 'first-letter:text-5xl first-letter:font-bold first-letter:text-blue-600 dark:first-letter:text-blue-400 first-letter:mr-3 first-letter:float-left first-letter:leading-none first-letter:mt-1' : ''
          }`}
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 0.9 + index * 0.1 }}
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between">
                ...
                <motion.button
                  ...
                  transition={{ delay: 0.3 }}
                >
                  <span className="text-white text-lg font-bold group-hover:rotate-90 transition-transform duration-300">×</span>
                </motion.button>
              </div>
            </motion.div>
                  ...
                  <div className="bg-white/20 backdrop-blur-md rounded-2xl p-4 border border-white/20">
                    <div className="flex items-center gap-3 text-white">
                      ...
                      <div className="flex-1">
                        <div className="font-semibold text-base">{blog.author.name}</div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="relative z-10 flex items-center justify-center gap-2">
                        <motion.span
                          animate={{ rotate: bookmarks.has(blog.id) ? [0, 15, -15, 0] : 0 }}
                  ...
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-400">
                        {(comments[blog.id] || []).length} comment{(comments[blog.id] || []).length !== 1 ? 's' : ''} • Join the conversation
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 mb-8">
                      ...
                      >
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-slate-600 dark:text-slate-300 whitespace-pre-wrap break-words leading-relaxed pl-13">
                              {comment.text}
                            </div>
                          </div>
                          <motion.button
                    ...
                    {!((comments[blog.id] || []).length) && (
                      ...
                      >
                        ...
                        <p className="text-lg">Be the first to share your thoughts on this article!</p>
                      </motion.div>
                    )}
                  </div>
